function displayData(selectedValue) {
    ...
    if (selectedValue === "1") {
        ...
        contentArea.innerHTML = "<h3>Centro Hospitalar Albert Sabin</h3><p>Jovem Aprendiz - Auxiliar de TI</p><ul><li>Criação de uma intranet com PHP, Drupal e banco de dados da Oracle</li><li>Manutenção de Máquinas</li><li>Auxílio para os funcionários que utilizavam o sistema DGS</li><li>Auxílio remoto via AnyDesk</li></ul><p>Ferramentas: Git, Trello, PHP, Oracle SQL, Drupal.</p>";
    } else {
